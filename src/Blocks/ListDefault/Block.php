			...
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					[
						...
						'label' => _x('Keywords', 'ACF field label', 'sha'),
						'name' => 'adb_keywords',
						'type' => 'textarea',
						'instructions' => _x('Individual words (separated by spaces) will be regarded as individual keywords. A single keyword containing spaces is not supported. (This is a restriction imposed by the API.) Displays offers with keyword “A” OR keyword “B”, AND the selected category.', 'ACF field label', 'sha'),
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => [
							'width' => '',
