...
if (true || $show_filter) {
	//wp_enqueue_script("jquery", "https://angebote.paerke.ch/api/lib/api-20/jquery.min.js", [], null, false);
	wp_enqueue_script("{$classNameBase}_i18n", "https://angebote.paerke.ch/api/lib/api-20/{$api->lang_id}.js", [], null, false);
	wp_enqueue_script("{$classNameBase}_jquery-ui", "https://angebote.paerke.ch/api/lib/api-20/jquery-ui.min.js", ["{$classNameBase}_i18n"], null, false);
	wp_enqueue_script("{$classNameBase}_parkapp", "https://angebote.paerke.ch/api/lib/api-20/ParkApp.min.js", ["{$classNameBase}_i18n", "{$classNameBase}_jquery-ui"], null, false);
	wp_enqueue_style("{$classNameBase}_parkapp-api", "https://angebote.paerke.ch/api/lib/api-20/api.css", [], null);
}
